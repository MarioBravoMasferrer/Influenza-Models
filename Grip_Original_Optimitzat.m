% function [error]=Grip_Original_Optimitzat(x0)
...
F=[0.01722;0.01663;0.01697;0.01717;0.01697;0.01684;0.01745;0.01790;0.01717;0.01710];
% F=x0;
TempsCR=0:7:364;
Error=[];
...
Imaxs(i)=max(I);
TotalInfectats(i)=sum(CasosReals);
% 
%% Gràfiques 
